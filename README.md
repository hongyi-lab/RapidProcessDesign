...
[![Tests](https://img.shields.io/badge/tests-810%2B%20passing-brightgreen)]()
...
- Aerodynamics and cruise: conventional aircraft use pretrained NeuralFoil + AeroSandbox. Cruise solves lift and pitch trim at three fuel masses, checks static margin and shaft power, and integrates fuel consumption. CG and engine power are editable assumptions. See the [physics model and validation guide](docs/physics-upgrade.md).
- Transparent fidelity: component buildup remains a conceptual model; whole-aircraft accuracy still needs independent validation. BWB retains its earlier low-order model.
