...
import { AIWorkspaceGate } from "@/components/chat/AIWorkspaceGate";
...
export default function Home() {
  ...
  return (
    <AIWorkspaceGate apiBaseUrl={API_BASE_URL}>
    <main className="workbench">
      <nav className="topbar">
        <strong>AeroSpec</strong>
        <span className="topbar-sep" />
        <span className="topbar-sub">AI aircraft workspace</span>
        <div className="topbar-right">
          ...
          >
            Compare{compareState.items.length > 0 ? ` (${compareState.items.length})` : ""}
          </button>
